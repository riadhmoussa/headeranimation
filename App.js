...
const App = ({ route }) => {
  const itemData = {
    ...
    image: "https://scontent.ftun9-1.fna.fbcdn.net/v/t39.30808-6/244421397_902907970639693_943100453836784578_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=-I9ryNbUuH4AX_G2Osc&_nc_ht=scontent.ftun9-1.fna&oh=3eddd8b7be201be67c418102a70db74c&oe=618CA8D2",
    rating: 4,
    reviews: 99,
      ...
      <HeaderImageScrollView
        ...
        renderForeground={() => (
          <View style={styles.titleContainer}>
            <Text style={styles.imageTitle}>Hello Wordl!!!</Text>
          </View>
        )}
